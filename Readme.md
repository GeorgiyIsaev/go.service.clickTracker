...
Задача
Нужно разработать сервис, который будет считать количество уникальных пользователей, кликнувших в любую публикацию автора за календарные су
...
- Когда мы собираем ленту рекомендаций для очередного пользователя - в наш сервис поступает запрос со списком авторов, для которых мы хотим
